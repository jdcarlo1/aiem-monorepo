...
# test file lives at <workspace_root>/tools/test_watchdog_gate.py
# aiem_process.py lives at <workspace_root>/artifacts/stock-scanner-api/aiem_process.py
_TOOLS_DIR    = os.path.dirname(os.path.abspath(__file__))
_WORKSPACE    = os.path.dirname(_TOOLS_DIR)
_AIEM_PY_PATH = os.path.join(_WORKSPACE, "artifacts", "stock-scanner-api", "aiem_process.py")
try:
