    ...
    <div style={{ background: "#060c14", minHeight: "100vh", fontFamily: "Inter,system-ui,sans-serif", color: "#fff", overflowX: "hidden" }}>
      ...
      <div className="relative text-center overflow-hidden" style={{ padding: "100px 24px 80px" }}>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <p className="mx-auto mb-6 text-slate-300" style={{ fontSize: "clamp(1.1rem,2.5vw,1.4rem)", maxWidth: "660px", lineHeight: 1.75 }}>
            Every other platform shows you signals in separate tabs and leaves the thinking to you. <strong className="text-white">StockScanner AI feeds all 44 signals into one AI simultaneously</strong> — dark pool, smart money, options flow, IV rank, gamma walls, max pain, market regime, dealer gamma exposure, volatility surface, macro cross-asset context, institutional whale blocks, MACD momentum, support &amp; resistance levels, volume profile POC, VWAP, and more — and outputs 3 complete, written trade setups every day.
          </p>
      ...
      <div className="px-6 pb-20 max-w-4xl mx-auto text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-4 text-left">
          {[
            { before: "You open 6 different tabs trying to figure out if signals agree.", after: "One AI reads all 44 signals together and tells you exactly what they say — combined.", icon: "🗂️" },
        ...
        <div className="rounded-3xl p-8 sm:p-10 relative overflow-hidden" style={{ background: "linear-gradient(135deg, rgba(34,197,94,0.07), rgba(6,12,20,1))", border: "2px solid rgba(34,197,94,0.3)", boxShadow: "0 0 80px rgba(34,197,94,0.07)" }}>
          ...
          <div className="relative">
            ...
            <p className="text-slate-300 mb-8" style={{ maxWidth: "620px", fontSize: "1.1rem", lineHeight: 1.75 }}>
              Every day, our AI reads all 44 signals simultaneously — dark pool flow, smart money vs retail divergence, options flow, IV rank, gamma walls, max pain, market regime (VIX + SPY trend), MACD momentum &amp; divergence, support &amp; resistance levels, volume profile POC, 20-day VWAP, RSI, momentum factors, OBV accumulation, revenue acceleration, analyst upgrades, earnings beat rate, VIX term structure, HYG credit health, and more. Then it outputs 3 complete trade setups, written in plain English, ranked from most bullish to most bearish.
            </p>
            <div className="grid sm:grid-cols-2 gap-6 mb-8">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    "All 44 signals → fed to AI together",
      ...
      <div className="px-6 pb-20 max-w-5xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-1.5 mt-5 text-slate-600 text-xs">
          <span><span className="font-bold text-emerald-400">🤖 AI Synthesis</span> — all 40 signals → 5 written trade setups daily</span>
      ...
      <div id="pricing" className="px-6 pb-28 max-w-xl mx-auto">
        <div className="rounded-3xl p-8 sm:p-10 relative overflow-hidden" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(34,197,94,0.2)", boxShadow: "0 0 80px rgba(34,197,94,0.08)" }}>
          ...
          <ul className="space-y-3.5 mb-8">
            {[
              { text: "🤖 AI Trade Synthesis — 40 signals → 3 written setups daily, no competitor has this", highlight: true },
