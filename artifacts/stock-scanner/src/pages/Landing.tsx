    ...
    <div style={{ background: "#060c14", minHeight: "100vh", fontFamily: "Inter,system-ui,sans-serif", color: "#fff", overflowX: "hidden" }}>
      ...
      <div className="relative text-center overflow-hidden" style={{ padding: "100px 24px 80px" }}>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <p className="mx-auto mb-6 text-slate-300" style={{ fontSize: "clamp(1.1rem,2.5vw,1.4rem)", maxWidth: "660px", lineHeight: 1.75 }}>
            Every other platform shows you signals in separate tabs and leaves the thinking to you. <strong className="text-white">StockScanner AI feeds all 40 signals into one AI simultaneously</strong> — dark pool, smart money, options flow, IV rank, gamma walls, max pain, market regime, dealer gamma exposure, volatility surface, macro cross-asset context, institutional whale blocks, and more — and outputs 3 complete, written trade setups every day.
          </p>
      ...
      <div className="px-6 pb-20 max-w-4xl mx-auto text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-4 text-left">
          {[
            { before: "You open 6 different tabs trying to figure out if signals agree.", after: "One AI reads all 40 signals together and tells you exactly what they say — combined.", icon: "🗂️" },
          ...
          <div className="relative">
            ...
            <div className="grid sm:grid-cols-2 gap-6 mb-8">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    "All 40 signals → fed to AI together",
