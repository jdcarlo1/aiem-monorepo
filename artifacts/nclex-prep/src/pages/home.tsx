                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
                  ...
                  <div className="rounded-2xl border border-border bg-card p-8 flex flex-col shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-200">
                    ...
                    <ul className="space-y-3 mb-8 flex-1">
                      {["All 2,000+ questions", "48 categories incl. Interview Prep", "NGN question formats", "AI explanations", "AI Adaptive Engine"].map((f) => (
                  ...
                  <div className="relative rounded-2xl border-2 border-primary bg-card p-8 flex flex-col shadow-lg">
                    ...
                    <ul className="space-y-3 mb-8 flex-1">
                      {["All 2,000+ questions", "48 categories incl. Interview Prep", "NGN question formats", "AI explanations", "AI Adaptive Engine", "All future updates included"].map((f) => (
                        <li key={f} className="flex items-center gap-2 text-sm text-foreground">
                          <CheckCircle className="w-4 h-4 text-green-500 shrink-0" />
                          {f}
                        </li>
