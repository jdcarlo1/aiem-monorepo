...
const comparisonRows = [
  { feature: "NGN (Next Generation NCLEX Test) formatted questions", us: true, them: false },
    ...
    <div className="min-h-[100dvh] flex flex-col bg-background">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="relative flex flex-col items-center justify-center text-center px-6 py-20 md:py-32 overflow-hidden">
          ...
          <p className="text-2xl font-extrabold text-primary mb-6 tracking-wide">🌐 nclexai.org</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <Link href="/quiz">
              <div className="group h-full p-7 rounded-2xl border-2 border-primary bg-card shadow-lg hover:shadow-xl transition-all duration-200 cursor-pointer flex flex-col relative">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed flex-1">Train exactly like the real CAT (Computerized Adaptive Test). Our AI Adaptive Engine adjusts every question to your performance — NGN (Next Generation NCLEX Test) formats, drag-and-drop, extended multiple response. When the computer shuts off at 85, you'll know why.</p>
                <div className="mt-5 flex items-center gap-1 text-primary text-sm font-semibold">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Select all that apply — the NGN (Next Generation NCLEX Test) format that trips most students. Practice until it feels natural.",
              },
              {
              ...
              },
              {
                ...
                title: "NGN (Next Generation NCLEX Test) Clinical Judgment",
                desc: "50+ Next Generation NCLEX Test questions built around the clinical judgment measurement model (CJMM).",
              },
              {
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
                  ...
                  <div className="rounded-2xl border border-border bg-card p-8 flex flex-col shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-200">
                    ...
                    <div className="flex items-baseline gap-1 mb-1">
                      <span className="text-5xl font-extrabold text-foreground">$22</span>
                  ...
                  <div className="relative rounded-2xl border-2 border-primary bg-card p-8 flex flex-col shadow-lg">
                    ...
                    <div className="flex items-baseline gap-1 mb-1">
                      <span className="text-5xl font-extrabold text-foreground">$110</span>
          ...
          <div className="max-w-2xl mx-auto">
            {sessionStatus?.isSubscribed ? (
              ...
              <>
                ...
                <p className="text-sm text-muted-foreground mt-4">10 free questions · $22/month or $110 lifetime · Cancel anytime</p>
              </>
            )}
          </div>
        </section>
