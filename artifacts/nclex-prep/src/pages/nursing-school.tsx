...
const ngnFormats = [
  ...
  },
  {
    ...
    icon: <ClipboardList className="w-6 h-6" />,
    questions: 30,
    desc: "6-question patient scenario sets that mirror the real NGN exam. One evolving patient — assess, analyze, prioritize, and intervene across connected questions just like test day.",
    color: "bg-blue-50 text-blue-700 border-blue-200",
    iconBg: "bg-blue-100",
    badge: "New",
  },
  {
    category: "NGN: Matrix/Grid",
    label: "Matrix / Grid Questions",
    icon: <LayoutGrid className="w-6 h-6" />,
    questions: 30,
    desc: "Check multiple boxes across rows and columns — identify nursing priorities, expected vs. unexpected findings, and appropriate interventions all in one question.",
    color: "bg-teal-50 text-teal-700 border-teal-200",
    iconBg: "bg-teal-100",
    badge: "New",
  },
  {
    category: "NGN: Cloze/Drop-Down",
    label: "Cloze / Drop-Down",
    icon: <AlignLeft className="w-6 h-6" />,
    questions: 30,
    desc: "Fill in the blank by selecting from dropdown options — complete clinical sentences with the correct diagnosis, medication, or nursing action.",
    color: "bg-amber-50 text-amber-700 border-amber-200",
    iconBg: "bg-amber-100",
    badge: "New",
  },
  {
    category: "NGN: Trend/Graphic",
    label: "Trend / Graphic Items",
    icon: <TrendingUp className="w-6 h-6" />,
    questions: 30,
    desc: "Interpret vital sign trends, lab value changes, and clinical data over time — identify deterioration, improvement, or the need for immediate intervention.",
    color: "bg-emerald-50 text-emerald-700 border-emerald-200",
    iconBg: "bg-emerald-100",
    badge: "New",
  },
  {
    category: "NGN: Highlight",
    label: "Highlight Questions",
    icon: <Highlighter className="w-6 h-6" />,
    questions: 30,
    desc: "Read a clinical note or nursing narrative and identify the words that indicate the patient's priority problem, risk factor, or expected finding.",
    color: "bg-yellow-50 text-yellow-700 border-yellow-200",
    iconBg: "bg-yellow-100",
    badge: "New",
  },
          ...
          {!isSubscribed && (
            <div className="mt-4 flex items-center gap-3 p-4 rounded-xl bg-primary/5 border border-primary/20">
              ...
              <p className="text-sm text-foreground">
                <span className="font-semibold">Premium feature.</span> Unlock all {totalCategories} question banks with a $110 lifetime plan.{" "}
